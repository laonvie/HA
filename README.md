...
## About
Kocom Wallpad with RS485 for Hoban

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/laonvie/HA 를 입력한 다음 ADD 버튼을 누릅니다.
...
7. share/kocom/ 폴더에 있는 kocom.conf 파일을 본인의 환경에 맞게 수정합니다. (SSH연결 필요)
...
(2024-03-02 진행중) Hoban용 변경사항 작업진행 중
